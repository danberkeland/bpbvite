...
export const BaguetteMix = ({ reportDate }) => {
  ...
  // (dont need?)
  // const B1bagOrdersByForBake = Object.values(groupBy(B1baguetteOrders, ['product.forBake']))
  ...
  // BPBN baker 1 printing report.
  //
  // Calculations for dough 'short' requires (reuses) "What to Bake" totals.
  const productsByForBake = groupBy(Object.values(products), ['forBake'])

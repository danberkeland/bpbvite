...
import { listOrdersByLocationByDate } from "../Data/gqlQueries"
  ...
  return(
    <div>
      ...
      <Button label="Submit Changes"
        onClick={() => handleStandingSubmit(location, isWhole, standingBase, standingChanges, mutateStanding, user.name, setIsLoading)}
 ...
 * cart order items.
 */
const handleStandingSubmit = async (location, isWhole, standingBase, standingChanges, mutateStanding, userName, setIsLoading) => {
  setIsLoading(true)

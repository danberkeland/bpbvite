...
const Orders2 = () => {
  ...
  const [orderTableRender, setOrderTableRender] = useState()
  ...
  useEffect( () => {
    if (orderTable) {
      const filteredOrderTable = orderTable.filter(item => item.route === tabIndexFulfillmentTypes[activeIndex])
      setOrderTableRender(filteredOrderTable)
    }
  }, [activeIndex])
      ...
      <div className="pageContainer">
            ...
            <div style={{padding: "2px 0px 2px 0px"}}>
              <Button label="Show" 
                onClick={() => {
                  ...
                  setOrderTableRender(prodsWithTotals.filter(item => item.route === tabIndexFulfillmentTypes[activeIndex]))
                }}
        ...
        <div className="card">
          ...
          <div className="card-body">
            <TabMenu 
              model={[
                {label: 'Delivery', icon: 'pi pi-send'},
                {label: 'Pickup SLO', icon: 'pi pi-shopping-bag'},
                {label: 'Pickup Carlton', icon: 'pi pi-shopping-bag'},
              ]} 

...
const getCustNames = (database, loc, delivDate) => {
  console.log("SpecialDate", convertDatetoBPBDate(delivDate));
  const [products, customers, routes, standing, orders] = database;
...
const makeSpecialOrders = (database, loc, delivDate) => {
  ...
  console.log("specialCustNames", custNames);
  let orderArray = [];
...
export default class ComposeSpecialOrders {
  ...
  getSpecialNorthColumns(database, delivDate) {
    let specialNorthColumns = makeSpecialColumns(
      database,
      "atownpick",
      delivDate
    );
  ...
  getSpecialSouthColumns(database, delivDate) {
    let specialSouthColumns = makeSpecialColumns(
      database,
      "slopick",
      delivDate
    );

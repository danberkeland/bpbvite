...
// const listTrainingsSimple = /* GraphQL */ `
//   query ListTrainings(
//     $id: String
...
// const listTrainingFull = /* GraphQL */ `
//   query listTrainings {
//     listTrainings {
//         items {
...
// const getTrainingDetails = /* GraphQL */ `
...
// const createTrainingMutation = /* GraphQL */ `
...
//   }
// `;
// const updateTrainingMutation = /* GraphQL */ `
...
//   }
// `;
// const deleteTrainingMutation = /* GraphQL */ `
...
//     shouldFetch ? [listTrainingsSimple, { limit: 1000 }] : null,
//     gqlFetcher,
//     defaultSwrOptions
//   );
...
//   mutate([listTrainingsSimple, { limit: 1000 }], null, {
//     revalidate: true,
//   });
// };
...
//   const { data, errors } = useSWR(
//     shouldFetch ? [listTrainingFull, { limit: 1000 }] : null,
//     gqlFetcher,
//     defaultSwrOptions
//   );
...
//   const { data, errors } = useSWR(
//     shouldFetch ? [getTrainingDetails, { id: id }] : null,
//     gqlFetcher,
//     defaultSwrOptions
//   );
...
//   mutate([getTrainingDetails, { id: id }], null, { revalidate: true });
// };
